...
public class ModelVendasProdutos {
    ...
    private double venProValorCompra;
    ...
    public void setVenProValorCompra(double pVenProValorCompra) {
        this.venProValorCompra = pVenProValorCompra;
    }

    /**
     * @return venProValor
     */
    public double getVenProValorCompra() {
        return this.venProValorCompra;
    }
